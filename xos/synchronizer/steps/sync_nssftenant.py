...
class SyncNSSFTenant(SyncInstanceUsingAnsible):
    ...
    template_name = "nssftenant_playbook.yaml"

    service_key_name = "/opt/xos/configurations/mcord/mcord_private_key"

    def __init__(self, *args, **kwargs):
        super(SyncNSSFTenant, self).__init__(*args, **kwargs)
...
# Gets the list of all available SPGWC, with PORTS/IP
	...
	#   {'name': 'NSSF_PUBLIC_IP', 'net_name': 'public'} # May be Required
        ]
